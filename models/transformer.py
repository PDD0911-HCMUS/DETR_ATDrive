...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, query_embed, query_embed_drive, pos_embed):
        ...
        _, hm = self.drive_decoder(tgt_drive, memory, memory_key_padding_mask=mask,
                          pos=pos_embed, query_pos=query_embed)

        return hs.transpose(1, 2), memory.permute(1, 2, 0).view(bs, c, h, w), hm
